...
(function(){
  ...
  function reloadLatest(){const hash=rememberScreen();try{localStorage.setItem('beauLastScreenHash',hash);}catch(e){}const u=new URL(OTA_URL,location.href);u.searchParams.set('v',Date.now().toString());u.hash=hash;window.location.replace(u.toString());}
