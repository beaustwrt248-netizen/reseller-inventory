...
(function(){
  ...
  function reloadLatest(){const hash=rememberScreen();try{localStorage.setItem('beauLastScreenHash',hash)}catch(e){}const u=new URL(OTA_URL,location.href);u.searchParams.set('v',Date.now());u.hash=hash;window.location.replace(u.toString())}
  window.BeauUpdate={version:CURRENT,isNative,check,reloadLatest};
  window.addEventListener('hashchange',()=>{try{localStorage.setItem('beauLastScreenHash',location.hash||'#dashboard')}catch(e){}});
