/* Beau's Game Inventory — OTA updater v2.5.0 */
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{loadScannerFix();loadCameraFix();setTimeout(()=>checkAndUpdate({silent:true}),1200)});
})();
