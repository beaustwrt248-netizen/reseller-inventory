/* Beau's Game Inventory — OTA updater v1.9.2 */
(function(){
  ...
  function loadScannerController(){if(document.getElementById('beauScannerController'))return;const s=document.createElement('script');s.id='beauScannerController';s.src='./scanner-fix.js?v='+Date.now();s.async=false;document.head.appendChild(s);}
