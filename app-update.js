/* Beau's Game Inventory — OTA updater v2.0.1 */
(function(){
const KEY='beauGameInventoryBuild',CURRENT='2.0.1',UPDATE_URL='./update.json',OTA_URL='./ota.html';
...
document.addEventListener('DOMContentLoaded',()=>{loadScript('beauScannerController','./scanner-fix.js?v='+Date.now());loadScript('beauLibrarySync','./library-sync.js?v='+Date.now());handleScannerReturn();setTimeout(()=>checkAndUpdate({silent:true}),1500)});
})();
