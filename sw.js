/* Beau's Game Inventory — cache refresh v3.0.0 */
const CACHE='beau-game-inventory-v3.0.0';
const ASSETS=['./','./index.html','./scanner.html','./scanner-v3.html','./library.html','./pricing.html','./settings.html','./dashboard.html','./mobile-theme.css','./app-nav.js','./app-update.js','./scanner-fix.js','./scanner-runtime-fix.js','./pricing-engine.js','./nav-safe-area.js','./navigation-layout-fix.css','./nav-icons.css','./manifest.json'];
